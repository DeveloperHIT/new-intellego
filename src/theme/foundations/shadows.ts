...
const createCustomShadows = (color: string) => {
  const transparent = (color: string, opacity: number) => alpha(color, opacity);

  return {
    z1: `0 1px 2px 0 ${transparent(color, 0.04)}`,
    z4: `-4px 4px 12px 0 ${transparent(color, 0.08)}`,
    z8: `-8px 8px 24px -4px ${transparent(color, 0.08)}`,
    z12: `-12px 12px 36px -4px ${transparent(color, 0.12)}`,
    z16: `-16px 16px 48px -8px ${transparent(color, 0.16)}`,
    z20: `-20px 20px 60px -8px ${transparent(color, 0.2)}`,
    z24: `-24px 24px 72px -8px ${transparent(color, 0.24)}`,
...
export const CustomShadowTokens: {
  light: CustomShadowOptions;
  dark: CustomShadowOptions;
} = {
  light: createCustomShadows(LIGHT_MODE),
  dark: createCustomShadows(DARK_MODE),
};
